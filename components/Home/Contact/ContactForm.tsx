      ...
      <form className="mt-8 block w-full overflow-hidden">
        ...
        <div className="mt-4">
          <div
            ...
            className="px-8 py-3.5 bg-[#7947df] w-fit text-white hover:bg-[#5c2fb7] transition-all duration-150 rounded-full"
          >
            Send Message
          </div>
        </div>
        {submitted && <p className="text-white mt-2">Thank you!</p>}
      </form>
    </div>
  );
};
